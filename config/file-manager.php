...
use App\Repositories\AccessController;
use App\Repositories\DiskManager;
...
return [
     ...
     */
    'configRepository' => DiskManager::class,
    ...
    'aclRepository' => AccessController::class,
    ...
    'aclRules' => [
        ...
        1 => [
            // ['disk' => 'public', 'path' => '*', 'access' => 2],
            // ['disk' => 'public', 'path' => 'personal/*', 'access' => 1],
        ],
    ],
];

    ...
    <div id="content">
        <div class="container">
            <div class="bg-white shadow-md rounded p-4">
                <h2 class="text-6 mb-3">Who am I?</h2>
                <div class="row">
                    <div class="col-md-7 text-justify">
                        <p>
                            I am a Software Engineer with a demonstrated history of working in the computer software
                            industry.
                            I have worked with many different types of software, including web, desktop, and mobile
                            applications.
                            I have experience in a wide range of programming languages, frameworks, and development tools.
                            I am a self-starter and I am always looking to learn new things.
                        </p>
                        <p>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolore voluptates, distinctio itaque
                            explicabo
                            consequatur voluptatem debitis voluptate fugit nisi quod totam neque illo, natus suscipit
                            magnam,
                            recusandae placeat sunt dolores illum ipsam. Quas unde debitis fugiat molestiae quod nisi sunt
                            dolore
                            soluta dolorum impedit. Et debitis nulla unde totam esse!
                        </p>
                    </div>
                    <div class="col-md-5">
                        <img class="img-fluid" src="{{ asset('images/me.jpg') }}" alt="" />
                    </div>
                    ...
                    <h2 class="text-6 mb-3">Our team</h2>
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-3">
                            <div class="team"> <img class="img-fluid rounded" alt=""

    ...
    <div id="content">
        <div class="container">
            ...
            <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the
                ...
                help of the
                <a href="https://www.privacypolicies.com/blog/privacy-policy-template/" target="_blank">Privacy Policy
                    Template</a>.
            </p>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Website</strong> refers to Arfius Collection, accessible from <a href="ArfiusCollection.com"
                            rel="external nofollow noopener" target="_blank">ArfiusCollection.com</a></p>
                </li>
                <li>
            ...
            <ul>
                <li>By email: sankarbala232@gmail.com</li>
            </ul>
        </div>
    </div>
@endsection
